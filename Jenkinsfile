node{
   ...
   stage('Push Image') {
       withDockerRegistry(credentialsId: 'ecr:eu-west-2:AWSSecretKeysAndAccessKeys', url: 'https://807395240887.dkr.ecr.eu-west-2.amazonaws.com/project-addressbook-2') {
           sh label: '', script: 'docker tag project-addressbook-2:${BUILD_NUMBER} 807395240887.dkr.ecr.eu-west-2.amazonaws.com/project-addressbook-2:${BUILD_NUMBER}'
   ...
   stage('Update Service'){
      ...
      secretKeyVariable: 'AWS_SECRET_ACCESS_KEY'
          ...
          sh label: '', script: 'aws ecs update-service --cluster Project-Addressbook-2 --service Project-Addressbook-2  --force-new-deployment --region eu-west-2'
     } 
  }
}
