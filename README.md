...
Addressbook Tutorial For Students
====================
...
- *Do not use the suggested J2EE Preview server* as it is outdated, deprecated and does not support Servlet 3, which is required for this applicat1
